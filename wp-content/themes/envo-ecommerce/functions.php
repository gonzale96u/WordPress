 ...
 */
define('ENVO_ECOMMERCE_VERSION', '1.0.13');
...
function envo_ecommerce_theme_stylesheets() {
    ...
    wp_enqueue_style('style', '/wp-content/themes/envo-ecommerce/style.css');
...
function cool_scripts() {
    wp_enqueue_script('cool-stuff', '/wp-content/themes/envo-ecommerce/js/script.js', array('jquery'));
}
